...
<html lang="en">
  <head>
   ...
   <!-- ======== META TAGS ======== -->
		...
		<meta name="description" content="This template has been auther by iThinq.net" /> <!-- Here write your description page -->
		...
		<div class="row nomargin">
			...
			<div class="col-sm-2 col-lg-2">
				<div id="logo-container">
					<a href="#home"><img data-inverse="assets/img/logo-invert.png" data-logo="assets/img/logo.png" src="assets/img/logo.png" alt="Wooshii, video made easy" title="Wooshii, video made easy"></a>
				</div>
			</div>
